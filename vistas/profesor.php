...
if ($tipo !== 'profesor') { header('Location: ../index.php'); exit; }
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<div class="layout">
    <aside class="sidebar">
        <div class="sidebar-header">
            ...
            <div class="sidebar-sub">TecNM · Campus Iguala</div>
        </div>
        ...
        <nav class="sidebar-nav">
            ...
            <a class="nav-item active" href="profesor.php"><i class="fas fa-home"></i> Inicio</a>
    ...
    <div class="main-content">
        <div class="topbar">
            ...
            <span class="topbar-title">Panel – Profesor</span>
